...
public interface ITravelDAO {
    ...
    // 관심 테마
    public ArrayList<TravelDTO> favorthemalist(TravelDTO dto);
    public int favorthemaNum(TravelDTO dto);
    
    // 관심 작가
    public ArrayList<TravelDTO> favorwriterlist(TravelDTO dto);
    public int favorwriterNum(TravelDTO dto);

...
<div class="login-form">
    <form action="exitform.do" method="post">
        ...
        <br>
        <div>
            <input type="password" class="form-control" name="userPw" id="userPw" required="required" placeholder="비밀번호를 입력해주세요." style="width: 100%;">
        </div>
       
        <br><br>
        
        <div style="text-align: center;">
          	<button type="button" class="btn" style="width: 240px; margin: 5px;">확인</button>

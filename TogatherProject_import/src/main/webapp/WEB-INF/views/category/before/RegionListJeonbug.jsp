...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=jeonbug" id="regionJeonbug" class="selectB"
            style="color: rgb(60, 127, 68);">전북</a>
      </div>
   </div>
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist16before.do?selectValue="+selectValue;

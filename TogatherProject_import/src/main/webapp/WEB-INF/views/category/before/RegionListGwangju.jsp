...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=gwangju" id="regionGwangju" class="selectB"
            style="color: rgb(60, 127, 68);">광주</a>
      </div>
      <div class="categoryS">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist14before.do?selectValue="+selectValue;

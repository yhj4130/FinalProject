...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=gyeongbug" id="regionGyeongbug" class="selectB"
            style="color: rgb(60, 127, 68);">경북</a>
      </div>
      <div class="categoryS">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist13before.do?selectValue="+selectValue;

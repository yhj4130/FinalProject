...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=gyeongnam" id="regionGyeongnam" class="selectB"
            style="color: rgb(60, 127, 68);">경남</a>
      </div>
   </div>
   <div class="categorySdiv">
      <div class="categoryS">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist11before.do?selectValue="+selectValue;

...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=gyenggi" id="regionGyeonggi" class="selectB"
            style="color: rgb(60, 127, 68);">경기</a>
      </div>
      <div class="categoryS">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist2before.do?selectValue="+selectValue;
   });
</script>

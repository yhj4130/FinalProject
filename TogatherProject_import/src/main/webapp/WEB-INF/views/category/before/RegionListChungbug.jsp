...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=chungbug" id="regionChungbug" class="selectB"
            style="color: rgb(60, 127, 68);">충북</a>
      </div>
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist7before.do?selectValue="+selectValue;

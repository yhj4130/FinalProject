...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS" style="width: 120px;">
         <a href="region.do?value=chungSe" id="regionChungSe" class="selectB"
            style="color: rgb(60, 127, 68);">충남/세종</a>
      </div>
      <div class="categoryS">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist8before.do?selectValue="+selectValue;

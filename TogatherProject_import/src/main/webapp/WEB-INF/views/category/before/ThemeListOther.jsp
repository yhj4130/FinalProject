...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="thema.do?value=ectTheme" id="themeOther" class="selectB"
            style="color: rgb(60, 127, 68);">기타</a>
      </div>
   </div>
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/themalistotherbefore.do?selectValue="+selectValue;

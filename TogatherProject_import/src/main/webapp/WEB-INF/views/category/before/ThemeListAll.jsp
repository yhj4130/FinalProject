...
<div class="contentList">
   ...
   <div class="categorySdiv">
      <div class="categoryS">
         <a href="thema.do?value=allTheme" id="themeAll" class="selectB"
            style="color: rgb(60, 127, 68);">전체</a>
      </div>
      <div class="categoryS">
         <a href="thema.do?value=nature" id="themeNature" class="selectN"
      ...
      <div class="categoryS">
         <a href="thema.do?value=ectTheme" id="themelistOther.do" class="selectN" onmouseout="change2(this)"
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/themalistallbefore.do?selectValue="+selectValue;
   });
</script>
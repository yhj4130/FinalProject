...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=jeonnam" id="regionJeonnam" class="selectB"
            style="color: rgb(60, 127, 68);">전남</a>
      </div>
      <div class="categoryS">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist15before.do?selectValue="+selectValue;

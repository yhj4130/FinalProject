...
<div class="contentList">
   ...
   <div class="categorySdiv">
      <div class="categoryS">
         <a href="region.do?value=allRegion" id="regionAll" class="selectB"
      ...
      <div class="categoryS">
         <a href="region.do?value=gangwon" id="regionGangwon" class="selectN"
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS" style="width: 110px;">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlistallbefore.do?selectValue="+selectValue;
   });

...
<div class="contentList">
   ...
   <div class="categorySdiv">
      ...
      <div class="categoryS">
         <a href="region.do?value=inchen" id="regionInchen" class="selectB"
            style="color: rgb(60, 127, 68);">인천</a>
      </div>
      <div class="categoryS">
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlist3before.do?selectValue="+selectValue;
   });
</script>

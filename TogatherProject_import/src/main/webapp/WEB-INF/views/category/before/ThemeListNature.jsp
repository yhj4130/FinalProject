...
<div class="contentList">
   ...
   <div class="categorySdiv">
      <div class="categoryS">
         <a href="thema.do?value=allTheme" id="themeAll" class="selectN" onmouseout="change2(this)"
            onmouseover="change1(this)">전체</a>
      </div>
      <div class="categoryS">
         <a href="thema.do?value=nature" id="themeNature" class="selectB"
            style="color: rgb(60, 127, 68);">자연</a>
      </div>
      <div class="categoryS" style="width: 120px">
         <a href="thema.do?value=culture" id="themeCT" class="selectN" onmouseout="change2(this)"
            onmouseover="change1(this)">문화/관광</a>
      </div>
      <div class="categoryS" style="width: 145px;">
         <a href="thema.do?value=sports" id="themeLS" class="selectN" onmouseout="change2(this)"
            onmouseover="change1(this)">레저/스포츠</a>
      </div>
      <div class="categoryS" style="width: 120px">
         <a href="thema.do?value=shopping" id="themeSF" class="selectN" onmouseout="change2(this)"
            onmouseover="change1(this)">쇼핑/맛집</a>
      </div>
      <div class="categoryS">
         <a href="thema.do?value=ectTheme" id="themeOther" class="selectN" onmouseout="change2(this)"
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/themalistnaturebefore.do?selectValue="+selectValue;

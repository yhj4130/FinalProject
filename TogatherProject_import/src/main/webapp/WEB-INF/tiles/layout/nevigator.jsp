...
<div class="category" style="width: 1140px; height: 50px; border: solid; border-color: gray">
	<div class="nevigatorBtn">
		...
		<div class="categoryMenu">
			<!-- 테마버튼 -->
			<div class="themaBtn"><a href="thema.do?value=allTheme">테마별</a></div>
			<div class="themaMenu">
				<div><a href="thema.do?value=allTheme">전체</a></div>
				<div><a href="thema.do?value=nature">자연</a></div>
				<div><a href="thema.do?value=culture">문화/관광</a></div>
				<div><a href="thema.do?value=sports">레저/스포츠</a></div>
				<div><a href="thema.do?value=shopping">쇼핑/맛집</a></div>
				<div><a href="thema.do?value=ectTheme">기타</a></div>
			</div>
			<!-- 지역버튼 -->
			...
			<div class="periodMenu">
				...
				<div><a href="period.do?value=ectPeriod">장기여행</a></div>
			</div>
		</div>

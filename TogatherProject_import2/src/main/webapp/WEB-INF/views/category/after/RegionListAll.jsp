...
<div class="contentList">
   ...
   <div class="categorySdiv">
      <div class="categoryS">
         <a href="regionlistall.do" id="regionAll" class="selectB"
      ...
      <div class="categoryS">
         <a href="regionlist6.do" id="regionDaejeon" class="selectN"
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/regionlistall.do?selectValue="+selectValue;
   });

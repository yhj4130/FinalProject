			...
			<div class="mypageMenu">
				...
				<div class="mypageButton">
					...
					<div style="width: 150px; height: 60px;">
						<div>
							<input type="button" value="모집중" onmouseout="change2(this)"
								onmouseover="change1(this)" class="btnMypage" id="otherUpload">
						</div>
					</div>
					<!--평가 -->
					<div style="width: 150px; height: 120px;">
						...
						<div>
							<a href="" class="btnMypageSub" id="otherEval1" style="color: black;">동행자 평가</a>
						</div>
						<div>
							<a href="" class="btnMypageSub" id="otherEval2" onmouseout="change2(this)"
								onmouseover="change1(this)">여행작가 평가</a>
						</div>
					</div>
				...
				<form id="myForm">
					<div class="mypageContent">
						<div style="width: 950px; height: 60px;">
							<span class="subMenuText">동행자 평가</span>
						</div>
						<div
							style="width: 950px; height: 40px; margin-top: 20px; margin-bottom: 20px;">
							<div style="width: 350px; margin-left: 20px; float: left">
								<span
									style="font-size: 20pt; font-weight: bold; font-family: 맑은 고딕;">매너
									점수 : ★★★☆☆</span>
							</div>
						</div>

	...
	<div class="container">
		<div class="row header">
			...
			<div class="logo col-md-12">
				<%@ include file="/WEB-INF/tiles/layout/header_bf.jsp"%>
								...
								<div class="text">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn b1"><input type="checkbox"
											name="loc" id="loc">자연</label> <label class="btn b1"><input
											type="checkbox" name="loc" id="loc">문화관광</label> <label
											class="btn b1"><input type="checkbox" name="loc"
											id="loc">레저/스포츠</label> <label class="btn b1"><input
											type="checkbox" name="loc" id="loc">쇼핑/맛집</label> <label
											class="btn b1"><input type="checkbox" name="loc"
											id="loc">기타</label>
									</div>
								...
								<div class="choice">
									<div class="con1 arrayflex margin20">
										...
										<div class="btn-group btn-group-toggle" data-toggle="buttons">
											...
											<label class="btn b1"><input type="checkbox"
												class="age" name="age" id="ageAll">40대</label> <label
												class="btn b1"><input type="checkbox" class="age"
												name="age" id="ageAll">50대 이상</label>
										</div>
									...
									<div class="con2 arrayflex margin20">
										...
										<div class="btn-group btn-group-toggle gender"
											...
											<label class="btn b1"><input type="radio"
												name="gender" id="gender">전체</label> <label class="btn b1">
												<input type="radio" name="gender" id="gender">동성
											</label>
										</div>
								...
								<div class="text">
									<div class="startAndEnd arrayflex">
										<label>여행 시작일<input type="date" class="form-control"
											...
											type="date" class="form-control" id="date2"></label>
									</div>
								</div>
							</div>
						</div>

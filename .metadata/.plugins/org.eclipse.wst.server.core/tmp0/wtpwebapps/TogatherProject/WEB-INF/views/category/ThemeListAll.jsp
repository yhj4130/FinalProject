...
<div class="contentList">
   ...
   <div class="categorySdiv">
      <div class="categoryS">
         <a href="themalistall.do" id="themeAll" class="selectB"
      ...
      <div class="categoryS" style="width: 120px">
         <a href="themalistsf.do" id="themeSF" class="selectN" onmouseout="change2(this)"
            onmouseover="change1(this)">쇼핑/맛집</a>
      </div>
      <div class="categoryS">
         <a href="" id="themelistOther.do" class="selectN" onmouseout="change2(this)"
...
<script type="text/javascript">
   ...
   $("#selectBest").change(function() {
      ...
      location.href="<%=cp %>/themalistall.do?selectValue="+selectValue;
   });
</script>
...
<div class="mypageMenu">
	...
	<div class="mypageButton">
		...
		<div style="width: 150px; height: 60px;">
			<div>
				<input type="button" value="쪽지함" class="btnMypage" style="color: black;" id="message">
			</div>
		</div>
		<!-- 나에 대한 평가 -->
		<div style="width: 150px; height: 120px;">
				...
				<table class="table table-hover" style="font-size: 13px; font-family: 맑은 고딕; text-align: center;">
					<thead>
						<tr style="background-color: lightgray;">
							...
							<th scope="col"><input type="checkbox" id="allCheck" onclick="allChk(this);" /></th>
						</tr>
					</thead>
					<tbody>
						<!-- foreach문 돌려야함 -->

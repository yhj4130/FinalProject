...
<div class="mypageMenu">
	...
	<div class="mypageButton">
		...
		<div style="width: 150px; height: 150px;">
			...
			<div>
				<a href="" class="btnMypageSub" id="jjim" style="color: black;">찜한 게시물</a>
			</div>
			<div>
	...
	<form id="myForm">
		<div class="mypageContent">
			<div style="width: 950px; height: 60px;">
				<span class="subMenuText">찜한 게시물</span>
			</div>
			...
			<div style="width: 950px; height: 30px;">
				<div style="width: 90px; height: 30px; float: right;">
					<input type="button" class="modifyB" style="height: 25px; font-size: 9pt;" onmouseout="change2(this)" onmouseover="change1(this)" value="선택항목삭제" onclick="fn_userDel()">
				</div>
			</div>
...
<script type="text/javascript">
	...
	function fn_userDel() {
		...
		document.myForm.delUserid.value = userid;

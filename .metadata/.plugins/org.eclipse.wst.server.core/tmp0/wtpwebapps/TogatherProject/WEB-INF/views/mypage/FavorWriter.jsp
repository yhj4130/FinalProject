		...
		<div class="mypageContent">
			...
			<div style="margin-bottom: 15px; width: 950px; height: 20px;">
				...
				<div style="width: 160px; float: right;">
					<input type="text" style="width: 105px; height: 25px; float: left; font-size: 11pt; font-family: 맑은고딕; border-radius: 4px;" placeholder="검색할 닉네임"> 
					<input type="button" class="modifyB" style="width: 50px; height: 25px; font-size: 11pt; margin-left: 5px; float: left;"
						onmouseout="change2(this)" onmouseover="change1(this)" value="검색">
				</div>
			</div>

...
<div class="mypageMenu">
	...
	<div class="mypageButton">
		...
		<div style="width: 150px; height: 150px;">
			...
			<div>
				<a href="" class="btnMypageSub" id="favorWriter" onmouseout="change2(this)" onmouseover="change1(this)">관심작가</a>
			</div>
			<div>
				<a href="" class="btnMypageSub" id="favorTheme" style="color: black;">관심테마</a>
			</div>
		</div>
		<!-- 동행자게시판 -->
	...
	<form id="myForm">
		<div class="mypageContent">
			...
			<div style="width: 100%; height: 40px; margin-top: 20px; margin-bottom: 30px;">
				<span style="font-size: 13pt; font-family: 맑은 고딕; margin-left: 20px; float: left;">※ 최대 3가지까지 선택 가능합니다.</span>
			</div>
			<div style="width: 800px; margin-left: 20px; margin-bottom: 20px;">
				<div style="width: 240px; height: 50px;">
					<div style="float: left; width: 210px;">
						<span style="font-family: 맑은 고딕; font-size: 20pt; font-weight: bold;">자연</span>
					</div>
					<div style="float: left; width: 30px; margin-top: 7px;">
						<input type="checkbox" value="자연" style="width: 30px; height: 30px;">
					</div>
				</div>
				<div style="width: 240px; height: 50px;">
					<div style="float: left; width: 210px;">
						<span style="font-family: 맑은 고딕; font-size: 20pt; font-weight: bold;">문화관광</span>
					</div>
					<div style="float: left; width: 30px; margin-top: 7px;">
						<input type="checkbox" value="문화관광" style="width: 30px; height: 30px;">
					</div>
				</div>
				<div style="width: 240px; height: 50px;">
					<div style="float: left; width: 210px;">
						<span style="font-family: 맑은 고딕; font-size: 20pt; font-weight: bold;">레저 / 스포츠</span>
					</div>
					<div style="float: left; width: 30px; margin-top: 7px;">
						<input type="checkbox" value="레저 / 스포츠" style="width: 30px; height: 30px;">
					</div>
				</div>
				<div style="width: 240px; height: 50px;">
					<div style="float: left; width: 210px;">
						<span style="font-family: 맑은 고딕; font-size: 20pt; font-weight: bold;">쇼핑</span>
					</div>
					<div style="float: left; width: 30px; margin-top: 7px;">
						<input type="checkbox" value="쇼핑" style="width: 30px; height: 30px;">
					</div>
				</div>
				<div style="width: 240px; height: 50px;">
					<div style="float: left; width: 210px;">
						<span style="font-family: 맑은 고딕; font-size: 20pt; font-weight: bold;">맛집</span>
					</div>
					<div style="float: left; width: 30px; margin-top: 7px;">
						<input type="checkbox" value="맛집" style="width: 30px; height: 30px;">
					</div>
				</div>
				<div style="width: 240px; height: 50px;">
					<div style="float: left; width: 210px;">
						<span style="font-family: 맑은 고딕; font-size: 20pt; font-weight: bold;">기타</span>
					</div>
					<div style="float: left; width: 30px; margin-top: 7px;">
						<input type="checkbox" value="기타" style="width: 30px; height: 30px;">
					</div>
				</div>
			</div>
			<div style="width: 950px; margin-left: 20px;">
				<div style="float: left; width: 110px; margin-right: 20px;">
					<input type="button" value="확인" onmouseout="change2(this)" onmouseover="change1(this)" style="width: 100%; height: 40px; background-color: blue;">
				</div>
				<div style="float: left; width: 110px;">
					<input type="button" value="취소" onmouseout="change2(this)" onmouseover="change1(this)" style="width: 100%; height: 40px; background-color: red;">
				</div>
			</div>
		</div>
	</form>

...
<link href="<c:url value="/resources/css/mypage/mypage.css" />" rel="stylesheet">
...
<body>
					...
					<div class="mypageContent">
						...
						<div style="width: 950px; height: 40px; margin-top: 20px; margin-bottom: 20px;">
							<div style="width: 350px; margin-left: 20px; float: left">
								<span style="font-size: 20pt; font-weight: bold; font-family: 맑은 고딕;">매너 점수 : ★★★☆☆</span>
							</div>
						</div>
	...
	<div class="row footer">
		...
		<div class="content col-md-12"><c:import url="/WEB-INF/tiles/layout/footer.jsp"></c:import></div>
		<div class="blank col-md-2"></div>
	</div>

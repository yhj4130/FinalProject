...
<div class="mypageMenu">
	...
	<div class="mypageButton">
		...
		<div style="width: 150px; height: 120px;">
			...
			<div>
				<a href="" class="btnMypageSub" id="eval1" style="color: black;">동행자 평가</a>
			</div>
			<div>
		...
		<div class="mypageContent">
			...
			<div style="width: 950px; height: 40px; margin-top: 20px; margin-bottom: 20px;">
				<div style="width: 350px; margin-left: 20px; float: left">
					<span style="font-size: 20pt; font-weight: bold; font-family: 맑은 고딕;">나의 매너 점수 : ★★★☆☆</span>
				</div>
			</div>
			<div style="margin-bottom: 15px; width: 950px; height: 25px;">
				<div style="margin-left: 25px; width: 100px; float: left;">
					<span style="font-size: 12pt; font-family: 맑은 고딕;">게시물 : 2</span>
				</div>
